...
**Current status (2026-09-17 02:10Z):** Random, TPE, Vanilla BO, and FlowGuard-Raw complete; FlowGuard-Calibrated running (launched 02:05:49Z, 16 adaptive trials). Headline: best QoR **0.1029** reached independently by TPE, Vanilla BO, and FlowGuard-Raw. Failure efficiency: Vanilla BO 0/16, TPE 3/16, Random 4/16, FlowGuard-Raw 5/16 — Raw reached the best QoR earliest (call 11) but its later picks failed; an honest mixed result. Fresh export: `results/flowguard_results_export.csv` (590 rows) + `results/flowguard_results_summary.json`.
...
| FlowGuard-Raw | 16 | 11 | **0.102856** (cand_014, reached at call 11 — earliest) | seed 1340; uncalibrated RF; 5 TIMING_FAIL |
...
| Winner GDS | `results/primary-optuna_tpe-v1/runs/trial_primary-optuna_tpe-cand_014/final/gds/tt_um_flowguard_stress.gds` (2,173,556 B) |
| Winner layout render (real KLayout PNG) | `results/primary-optuna_tpe-v1/runs/trial_primary-optuna_tpe-cand_014/final/render/tt_um_flowguard_stress.png` (1000×312, 45 KB) |
| Contrasting failing layout | `results/diag_15p8_v1/runs/trial_clock15p8-u30-d45-p2-g0p1-sAREA_1/final/render/tt_um_flowguard_stress.png` (padding 2 / AREA 1, TIMING_FAIL) |
| Results export | `results/flowguard_results_export.csv` (590 rows, all namespaces) + `results/flowguard_results_summary.json`; regenerated by `experiments/export_results.py` |
| Data charts | `pitch/charts/c00_idea.png … c09_waste.png` (10 charts, partial-data build) |
